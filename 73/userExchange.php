			...
			<div class="userpage center">
				...
				<div class="leftarea f">
					<div class="exchange mb50">
						...
						<div class="type">
							<a class="act" href="javascript:;" title="" style="background-image:url(./img/02.png);"><i></i></a>
							<a href="javascript:;" title="" style="background-image:url(./img/01.gif) ;"><i></i></a>
						</div>
						...
						<div class="list">
							...
							<div class="form">
								<div class="figure" img="./img/4.png" col="100" value="998" ></div>
